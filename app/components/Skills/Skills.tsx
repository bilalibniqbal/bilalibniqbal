...
const Skills = (props: Props) => {
    ...
    return (
        <div className='max-w-[1280px] mx-auto'>
            <motion.div initial={{ height: 0 }} whileInView={{ height: '160px' }} transition={{ delay: 0.2 }} className=" md:ml-10 ml-3 h-[160px] mt-[-20px] w-[3px] rounded-md bg-gradient-to-b from-transparent via-[#4a2574] to-[#9372c3]" ></motion.div><br />
            <div className='flex md:pl-7 space-x-3 md:space-x-10'>
                <div className='flex flex-col items-center'>
                    ...
                    <motion.div initial={{ height: 0 }} whileInView={{ height: '100%' }} transition={{ delay: 0.8 }} className=" h-full w-[3px] mt-7 rounded-md bg-gradient-to-b from-[#4a2574] via-[#9372c3] to-transparent" ></motion.div>
                </div>
                <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.6, type: 'tween' }} className='md:w-10/12 mb-24'>
                    <h2 className="text-[20px] md:text-2xl mb-7 text-[#7338a0] font-medium js-build-in-item build-in-slideX-left build-in-animate  text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl" style={{ transitionDelay: '200ms' }}>Skills</h2>
                </motion.div>
            </div>
            {/* <Degree /> */}

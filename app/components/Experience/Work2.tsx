    ...
    return (
        <HoverCard backgroundColor='#7ee787' direction='' left='0'>
            <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
                ...
                <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Sr. AI Solutions Architect (Team Lead)</span> <br/> Aug 2022 - Present · 1 yr 9 mos </p>
                <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Sr. Machine Learning Engineer</span> <br/> Aug 2022 - Present · 1 yr 9 mos </p>
                <div>

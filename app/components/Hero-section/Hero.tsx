        ...
        <div className='relative max-w-[1280px] lg:pt-32 md:px-10 mx-auto pt-16'>
            ...
            <div className='flex'>
                ...
                <div className=' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                        ...
                        <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://bilalibniqbal.github.io/bilal-labs/" className=' border-[1px] border-neutral-600 copilot rounded-full inline-block'>
                            <div className='flex items-center p-3 px-5'>
                                ...
                                <div className='md:pr-5 pr-3 md:mr-2 md:pl-2'>
                                    <div className='font-medium text-white text-[16px] max-md:text-[14px] leading-5'>Bilal Labs</div>
                                    <div className='text-neutral-500 max-md:text-[14px] text-[16px]'>Powering the Future with AI</div>
                                </div>
                    ...
                    <h1 className="md:mt-24 lg:mt-28 sm:mt-10 relative z-2 max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[80px] font-semibold text-white"> Muhammad Bilal</h1>
                    <p className="relative z-1 text-[24px] md:text-[28px]  lg:text-[32px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:10/12  lg:w-12/12 text-[#7d8590]">
                        <span>Founder & Chief Scientist at Bilal Labs <br /> Sr. AI Solutions Architect (Team Lead) at DataPoint</span>
                    </p>
                    <div className='flex lg:w-11/12 md:space-x-5 max-md:flex-col'>
                        ...
                        <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="cv.pdf" className='flex items-center w-full md:w-auto justify-center text-[16px] py-3 px-5 max-md:mt-4 rounded-md border-[#ae88f9] border-[1.5px] text-white'>
                            Download CV
                    ...
                    {/* <div className='md:my-32 my-24'>
                        ...
                        <div className="flex flex-wrap justify-between items-center">
                            <img src="image.svg" alt="Stripe logo" height="44" className="my-3 scale-90" />
                            <img src="image.svg" alt="Mercedes-Benz logo" height="44" className="my-3 w-[200px]" />
                        </div>
                    </div> */}
                </div>
            </div>

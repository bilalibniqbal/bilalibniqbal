        ...
        <div className='max-w-[1280px] mx-auto'>
            ...
            <div className='flex md:pl-7 space-x-3 md:space-x-10'>
                ...
                <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.6, type: 'tween' }} className='md:w-10/12 mb-24'>
                    <h2 className="text-[20px] md:text-2xl mb-7 text-[#e5d300] font-medium js-build-in-item build-in-slideX-left build-in-animate  text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl" style={{ transitionDelay: '200ms' }}>Projects</h2>
                </motion.div>
            </div>
            {/* <Degree /> */}
